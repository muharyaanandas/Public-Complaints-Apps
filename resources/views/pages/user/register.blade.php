                        ...
                        <form action="{{ route('user.register-post') }}" role="form" method="POST">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <textarea type="text" value="{{ old('alamat') }}"
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input type="number" value="{{ old('rt') }}"
                                        class="form-control @error('rt') is-invalid @enderror" name="rt" id="rt"
                                        placeholder="rt001">
                                    @error('rt')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input type="number" value="{{ old('rw') }}"
                                        class="form-control @error('rw') is-invalid @enderror" name="rw" id="rw"
                                        placeholder="rw002">
                                    @error('rw')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input type="number" value="{{ old('kode_pos') }}"
                                        ...
                                        max="99999" id="kode_pos" placeholder="kd pos16515">
                                    @error('kode_pos')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <select name="regency_id"
                                        class="custom-select @error('regency_id') is-invalid @enderror" id="regency_id">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <select name="village_id"
                                        class="custom-select @error('village_id') is-invalid @enderror" id="village_id">
